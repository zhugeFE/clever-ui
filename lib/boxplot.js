...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_boxplot_vue__ = __webpack_require__(83);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__boxplot__ = __webpack_require__(140);
      ...
      return function (params) {
        ...
        if (params.seriesType === 'boxplot') {
          ...
          params.value.forEach(function (v, i) {
            if (i === 0) return;
            if (i <= labels.length) {
              rows.push(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* util */].getTooltipLabel(labels[i - 1]) + ': <span>\n              ' + __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* util */].timeFormat(parseInt(v + '000')) + _this.valueUnit + '</span>');
            }
          });
        }
