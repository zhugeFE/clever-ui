...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_charts_vue__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__charts_vue__ = __webpack_require__(147);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: {
    ...
    store: {
      ...
      validator: function validator(store) {
        return store && __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(store.series) && __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(store.x_axis);
      }
    },
    ...
    yAxisFormatter: {
      ...
      default: function _default(value) {
        if (parseFloat(value) >= 1000) {
          return __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].toThousands((value / 1000).toFixed(1)) + 'k';
        } else {
          return value;
        }
      }
    ...
    xAxisFormatter: {
      ...
      default: function _default(label) {
        if (/^\d{4}-\d{2}-\d{2}$/.test(label)) {
          ...
          label = __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].strMiddleSplit(label);
          if (/:/.test(label)) {
    ...
    colors: {
      ...
      default: function _default() {
        return __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].colors;
      }
    },
    ...
    stack: {
      ...
      validator: function validator(stack) {
        return __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(stack);
      }
    },
  ...
  computed: {
    tooltipFormat: function tooltipFormat() {
      ...
      return function (params) {
        ...
        params.forEach(function (item) {
          ...
          series.push('' + item.marker + name + ': <span style="color:#66ccff;">' + __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].toThousands(item.value) + _this.valueUnit + '</span>');
        });
    ...
    showListMap: function showListMap() {
      var map = {};
      if (__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(this.showList)) {
        this.showList.forEach(function (item) {
          if (__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(item)) {
            map[item.join('-')] = true;
          } else if (__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isString(item)) {
            map[item] = true;
          }
        });
      }
    ...
    showEmpty: function showEmpty() {
      return !this.chartStore.series.length || !this.option.series.length || __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(this.showList) && !this.showList.length;
    }
  },
  watch: {
    option: function option() {
  ...
  methods: {
    ...
    dashedLineFormat: function dashedLineFormat(option) {
      ...
      option.xAxis.data.forEach(function (label, index) {
        ...
        var currentDateTime = __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].dateFormat(currentDate, 'yyyymmdd');
    ...
    addDashedSeries: function addDashedSeries(series, dashedIndex) {
      var dashedSeries = __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].clone(series);
    ...
    getMarkLine: function getMarkLine() {
      ...
      this.markLine.forEach(function (item) {
        if (__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isString(item)) {
          arr[xMap[item]] = 'rgb(254,177,177)';
        } else if (__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isNumber(item)) {
    ...
    getYAxis: function getYAxis() {
      ...
      if (this.doubleY) {
        ...
        for (var key in this.yAxisRule) {
          ...
          result[rule.index] = __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].mergeObject(axis, __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].clone(rule.option || {}));
        }
        return result;
      }
      return axis;
    ...
    getLegend: function getLegend() {
      ...
      return {
        ...
        formatter: this.legendFormatter || function (label) {
          ...
          return __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].strMiddleSplit(label, {
            maxLength: maxLength,
    ...
    getBarSeries: function getBarSeries(name, series) {
      ...
      if (series.stack) {
        ...
        result = __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].mergeObject(series.option, result);
      }
      return result;
    },
    getLineSeries: function getLineSeries(name, series) {
      return {
        name: name,
        type: 'line',
        data: __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].clone(series.values),
        symbol: 'circle',
        symbolSize: 5,
        showAllSymbol: false,
        yAxisIndex: this.doubleY ? this.yAxisRule[name].index : 0,
    ...
    each: function each(handle) {
      ...
      this.chartStore.series.forEach(function (series, index) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].isArray(_this5.showList) && !_this5.showListMap[name] && !_this5.reverseXAxis) {
          return;
        }
    ...
    setOption: function setOption(option) {
      this.chart.clear();
      this.chart.setOption(this.resizeGrid(__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* util */].clone(option)));
    },
