...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flow_vue__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__flow_vue__ = __webpack_require__(147);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: {
    ...
    data: {
      ...
      validator: function validator(store) {
        return store && __WEBPACK_IMPORTED_MODULE_2__utils__["b" /* util */].isArray(store.points) && __WEBPACK_IMPORTED_MODULE_2__utils__["b" /* util */].isArray(store.lines);
      }
    },
  ...
  methods: {
    ...
    setOption: function setOption(option) {
      this.chart.setOption(__WEBPACK_IMPORTED_MODULE_2__utils__["b" /* util */].clone(option));
    },
