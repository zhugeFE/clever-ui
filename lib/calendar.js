...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_calendar_vue__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__calendar_vue__ = __webpack_require__(139);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_day_vue__ = __webpack_require__(85);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_task_vue__ = __webpack_require__(86);
/* unused harmony namespace reexport */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__selector__ = __webpack_require__(78);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getDayClass: function getDayClass(day) {
      ...
      var isToday = __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(new Date()) === __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(day);
      var isCurrent = __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(this.currentDay) === __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(day);
      return {
        'c-cld-day': true,
    ...
    getDays: function getDays(currentDay) {
      ...
      var lastDay = new Date(new Date(currentDay.getFullYear(), currentDay.getMonth() + 1, 1).getTime() - __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dayTime);
      var firstOfWeek = new Date(firstDay.getTime() - firstDay.getDay() * __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dayTime);
      var lastOfWeek = new Date(lastDay.getTime() + (6 - lastDay.getDay()) * __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dayTime);
      var totalDays = (lastOfWeek.getTime() - firstOfWeek.getTime()) / __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dayTime + 1;
      var days = [];
      var week = [];
      for (var i = 0; i < totalDays; i++) {
        var date = new Date(firstOfWeek.getTime() + i * __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dayTime);
        if (!date.getDay()) {
          week = [];
        }
        week.push(date);
    ...
    onNextDay: function onNextDay() {
      this.onClickDay(new Date(this.currentDay.getTime() + __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dayTime));
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      id: __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].guid()
    };
  },
  ...
  computed: {
    dayClass: function dayClass() {
      ...
      var isToday = __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(new Date()) === __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(this.day);
      var isCurrent = __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(this.currentDay) === __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].dateFormat(this.day);
      return {
        'c-cld-day': true,
        'c-cld-secondary': !week || week === 6 || isOtherMonth,
        'c-cld-today': isToday,
      ...
      this.taskList.forEach(function (item, i) {
        if (_this2.isValidTask(item)) {
          ...
          positionList.push({
            task: item,
            list: {
              affect: __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].clone(affectList).map(function (item) {
                return item.name;
              }),
              cross: __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].clone(crossToday).map(function (item) {
                return item.name;
              })
            },
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(_this2.day, item.beginDate) > 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(_this2.day, item.endDate) > 0) {
          var flag = false;
          _this2.taskList.forEach(function (task, j) {
            if (j <= i) return;
            if (__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(item.endDate, task.beginDate) >= 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(task.endDate, _this2.day) >= 0) {
              flag = true;
            }
          });
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(_this2.day, item.beginDate) > 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(_this2.day, item.endDate) <= 0 && _this2.day.getDay() !== 0) {
          crossToday.push(item);

          affectList.forEach(function (task) {
            if (__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(item.beginDate, task.endDate) > 0) {
  ...
  methods: {
    ...
    isValidTask: function isValidTask(task) {
      var isOneDay = __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].isOneDay(task.beginDate, this.day);

      var crossWeek = this.day.getDay() === 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(this.day, task.beginDate) > 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(this.day, task.endDate) < 0;
    ...
    onClickTask: function onClickTask(task) {
      if (__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].isFunction(task.onClick)) {
        task.onClick(task);
      }
    }
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    dayCount: function dayCount() {
      return __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(this.task.beginDate, this.task.endDate);
    },
    isCrossWeek: function isCrossWeek() {
      return this.day.getDay() === 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(this.day, this.task.beginDate) > 0 && __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(this.day, this.task.endDate) < 0;
    },
    showAble: function showAble() {
      var isOneDay = __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].isOneDay(this.task.beginDate, this.day);
    ...
    style: function style() {
      ...
      if (this.isCrossWeek) {
        dayCount = Math.min(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].compareDays(this.day, this.task.endDate) - 1, 7);
      }
      return {
        width: dayCount * this.width - 10 + 'px',
        background: this.task.color || __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].colors[0]
      };
    }
  },
  methods: {
    onClick: function onClick() {
      if (__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].isFunction(this.task.onClick)) {
