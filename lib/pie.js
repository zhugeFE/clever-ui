...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    option: function option() {
      var context = this;
      return {
        color: __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].colors,
        ...
        legend: {
          ...
          formatter: function formatter(name) {
            var maxLength = context.getMaxLabelLength();
            return __WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].strMiddleSplit(name, {
              maxLength: maxLength,
  ...
  methods: {
    ...
    setOption: function setOption(option) {
      this.chart.clear();
      this.chart.setOption(this.optionWrapper(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* util */].clone(option)));
    },
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pie_vue__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pie_vue__ = __webpack_require__(155);
