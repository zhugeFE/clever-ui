  ...
  computed: {
    ...
    tooltipFormat: function tooltipFormat() {
      ...
      return function (params) {
        ...
        rows.push('<div class="tooltip-title">' + params.marker + ' <div class="tooltip-name">' + params.seriesName + '</div></div>');
        var seriesData = [];
        if (params.seriesType === 'boxplot') {
          ...
          value.forEach(function (v, i) {
            if (i === 0) return;
            if (i <= labels.length) {
              seriesData.push(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* util */].getTooltipLabel(labels[i - 1]) + ': <span>\n              ' + __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* util */].timeFormat(parseInt(v + '000')) + _this.valueUnit + '</span>');
            }
          });
        }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    option: function option() {
      var context = this;
      return {
        color: this.colors && this.colors.length ? this.colors : __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* util */].colors,
        backgroundColor: 'white',
        tooltip: {
          trigger: 'item',
          textStyle: {
      ...
      [h(
        ...
        [h(
          'div',
          {
            ...
            'class': 'c-drop-panel', ref: 'dropPanel', style: this.dropdownStyle },
          [h(
            'div',
