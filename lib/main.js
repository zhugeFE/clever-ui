        ...
        this.innerStore.forEach(function (option) {
          if (_this5.childrenField) {
            option[_this5.childrenField].forEach(function (children) {
              ...
              if (children[_this5.keyField] === data[_this5.keyField] && !_this5.chosenList.length) {
                _this5.chosenList.push(children);
              }
            });
          } else {
            _this5.$set(_this5.checkedMap, option[_this5.keyField], option[_this5.keyField] === data[_this5.keyField]);

            if (option[_this5.keyField] === data[_this5.keyField] && !_this5.chosenList.length) {
              _this5.chosenList.push(option);
            }
          }
        });
        this.showOptions = false;
...
var Tooltip = __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].extend({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      var tipRect = {
        width: _this2.$refs.tooltip.offsetWidth,
        height: _this2.$refs.tooltip.offsetHeight
      };
