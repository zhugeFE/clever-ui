<template>
  <div ref="zgFlow" class="zg-flow" v-resize="onResize" :style="style">
    <div class="zg-flow-main" ref="toChart"></div>
    <!-- <div :style="{'line-height': height + 'px'}" class="zg-flow-empty">暂无数据</div> -->
  </div>
</template>
